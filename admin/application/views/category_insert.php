                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Input Category</h1>
                        </div>
                        <form class="user"  method="POST" action="<?php echo base_url('category/add_category') ?>" enctype="multipart/form-data">
